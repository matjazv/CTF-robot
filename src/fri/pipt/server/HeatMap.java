...
import fri.pipt.arena.SwingView.Palette;
import fri.pipt.server.Field.BodyPosition;
import fri.pipt.server.History.HistoryPosition;

public class HeatMap implements Arena, Palette, GameListener {
	...
	public HeatMap(Field field, History history, Agent agent, int neighborhoodSize) {
		this.field = field;
